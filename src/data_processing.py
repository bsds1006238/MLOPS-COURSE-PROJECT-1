...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            logger.error(f"Error in Proprocessing step {e}")
            raise CustomException(f"Error while preprocess data ", e)     
    
    def balance_data(self,df):
                   
            try:
                logger.info("Handling implaced data")
    ...
    def select_features(self,df):
        try:
            ...
            logger.info("Feature selection complted succesfully")
            
            return top_10_df
        
        except Exception as e:
                logger.error(f"Error in Feature selection step {e}")
                raise CustomException(f"Error while feature selection data ", e)
